...
class ChemicalUseState extends State<ChemicalUse> {
  ...
  void initState() {
    super.initState();
    data.chemicalUseController.addListener(() {
      data.commentsChemicalUse = data.chemicalUseController.text;
    });
  }
                ...
                Column(
                  children: [
                    ...
                    TaskItem(
                        key: Key('28'),
                        label:
                            "28. Hazardous chemicals stored above eye level"),
                    ...
                    SubTaskItem(
                        key: Key('33a'), label: "a. Full chemical name"),
                    SubTaskItem(
    ...
    return TextButton(
      onPressed: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SafetyEquipment(title: "")));
      },
      child: Container(
        color: Colors.blue,
